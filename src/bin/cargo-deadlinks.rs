...
Options:
    ...
    --ignore-intra-doc-links    Don't check URL fragments.
...
struct MainArgs {
    ...
    flag_ignore_intra_doc_links: bool,
...
impl From<&MainArgs> for CheckContext {
    fn from(args: &MainArgs) -> CheckContext {
        CheckContext {
            ...
            check_intra_doc_links: !args.flag_ignore_intra_doc_links,
        }
    }
}
...
fn parse_args() -> Result<MainArgs, shared::PicoError> {
    ...
    let main_args = MainArgs {
        ...
        flag_ignore_intra_doc_links: args.contains("--ignore-intra-doc-links"),
